...
/**
 *  类名称:FindBackFirstServlet
 *
 *  类作用：用于在找回密码功能中为前端提供用户所设置的安全问题
 *
 *  启动时间:2018年4月15日
 *
 *  最终修改时间:2018年4月15日
...
//实现此Servlet注册
@WebServlet(name = "FindBackFirstServelt",urlPatterns = {"/main/java/com.yunding.news/web/control/FindBackFirstServlet"})

public class FindBackFirstServelt extends HttpServlet {
